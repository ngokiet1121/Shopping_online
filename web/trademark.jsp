<%-- 
    Document   : trademark
    Created on : Dec 28, 2015, 6:57:21 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
                <%                    
                    int idTra = Integer.parseInt(request.getSession().getAttribute("idTra").toString());
                    Trademark tra = (Trademark) Controller.controller.findTra(idTra);
                %>
                <div class="col-md-9" style="width:100%; position: relative; left: -120px">
                    <div class="banner2">
                        <img src="img/<%= tra.getBanner()%>" alt=""/>
                    </div>
                </div>                 
                    <hr>
                        ...
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                <c:when test="${currentPage eq i}">
                                    ...
                                    <c:otherwise>
                                    <li><a href="trademark?page=${i}&idTra=${idTra}">${i}</a></li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
